...
impl HttpClient {
    ...
    pub fn get(&self, host: String, port: u16, path: String) -> Result<String, Error> {
        ...
        match core::str::from_utf8(&received) {
            Ok(response) => match HttpResponse::new(response.to_string()) {
                Ok(http_response) => Ok(http_response.body()),
                Err(e) => Err(e),
            },
